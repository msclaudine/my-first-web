...
var t
e.remove()
a.default.trackEvent("hide_embedded_content","hide_media")}},u=function(e){(0,a.default)(e.target).find("div.mejs-audio").focus()};(0,a.default)(document).on("click","a.instructure_inline_media_comment",(0,o.default)(function(){if(INST.kalturaSettings){var e=(0,a.default)(this),t="video",i=s.getMediaCommentId(e),d=s.buildCommentHolder(e);(function(e){return function(e){return e.closest("td").length>0}(e)&&function(e){return e.closest("td").css("width").replace("px","")<300}(e)})(e)&&function(e){var t=e.closest("td"),i=t.css("width")
t.data("orig-width",i)
t.css("width","300px")}(e)
e.after(d)
...
i("QfIG3OPdTK")
function o(e){return e&&e.__esModule?e:{default:e}}var d={},r={setPosition:function(e){function t(){return(e.tooltipClass||"").match("popover")?30:5}var i="true"===e.force_position?"none":"flipfit",n={right:{my:"left center",at:"right+"+t()+" center",collision:i},left:{my:"right center",at:"left-"+t()+" center",collision:i},top:{my:"center bottom",at:"center top-"+t(),collision:i},bottom:{my:"center top",at:"center bottom+"+t(),collision:i}}
...
if(function(e){return d[e]||d[e[0]]}(t))return null
var r=Array.prototype.slice.call(arguments,0)
r.splice(2,1,(0,a.default)(i).toString())
if(!this.timeout){var s=this._superApply.bind(this,r)
...
a?n.default.ajaxJSON(a,"DELETE",{},r,function(){return d.show()}):r()}(o)
...
o&&d.attr("target",o)
d.hide().append(r).appendTo("body").submit()}(o)
return!1}})}},["VDPlEqaRwD"])

//# sourceMappingURL=common.bundle-d72bcdba69.js.90-d72bcdba69.sourcemap